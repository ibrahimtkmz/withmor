...
export default function App() {
  ...
  // GALERİ İÇİN STATE - ARTIK RESİM + VİDEO DESTEKLER
  ...
  // HİZMETLER İÇİN YEREL GÖRSELLER
  ...
  const openEdit = (type, index = null) => {
    ...
    if (type === "gallery" && index !== null) {
      ...
      if (typeof item === "string") {
        setTempValue({ type: "image", url: item });
      } else {
        setTempValue(item || { type: "image", url: "" });
      }
    }
  };
  ...
  const saveEdit = () => {
    ...
    if (type === "gallery") {
      if (index !== null) {
        ...
        setGalleryImages([...galleryImages, tempValue]);
      }
    }
    ...
    <div className="min-h-screen bg-white text-slate-800 font-sans selection:bg-blue-100 overflow-x-hidden">
      ...
      >
        <div className="mx-auto max-w-6xl px-6">
          ...
          <div
            key={activeAboutTab}
            className="grid lg:grid-cols-12 gap-12 items-start animate-in fade-in duration-500"
          >
            {/* Sol: Bina Görseli */}
            ...
            <div className="lg:col-span-4 flex flex-col justify-center h-full pt-4">
              ...
              <h3 className="text-xl font-bold text-slate-800 mb-2">
                {aboutTabs[activeAboutTab].heading}
              </h3>
              <h4 className="text-lg font-bold text-blue-700 mb-6">
                {aboutTabs[activeAboutTab].subHeading}
              </h4>
            ...
            <div className="lg:col-span-4">
              <div className="bg-slate-50 p-8 rounded-2xl text-center border border-slate-100 h-full flex flex-col justify-center items-center">
                ...
                <p className="text-slate-600 text-sm italic relative px-4">
                  <span className="text-4xl text-slate-200 absolute -top-4 left-0">
                    "
                  </span>
                  Withmor, Türkiye genelinde endüstriyel ve özel mimari
                  projelerde 30 yılı aşkın deneyimiyle hizmet vermektedir. Yük
                  asansörleri, yük platformları, villa asansörleri ve yatay
                  asansörlerde güvenilir çözüm ortağınız.
                  <span className="text-4xl text-slate-200 absolute -bottom-8 right-0">
                    "
                  </span>
                </p>
            ...
            <div className="space-y-12">
              ...
              <div className="flex gap-6 group">
                ...
                <div>
                  ...
                  <p className="text-slate-600 text-sm leading-relaxed">
                    ...
                    yenilikçi ve ileri teknolojiye dayalı asansör çözümleri
                    sunar. Teknolojinin sunduğu avantajları projelerinize
                    entegre ederek verimliliği artırır.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-6 group">
                ...
                <div>
                  ...
                  <p className="text-slate-600 text-sm leading-relaxed">
                    Müşteri memnuniyetini en üst düzeyde tutmak için satış
                    öncesi ve sonrası kesintisiz destek sağlıyoruz. Türkiye’nin
                    her yerinden 24 saat 444 37 59 numaralı telefondan
                    ulaşabileceğiniz teknik servisimizle ihtiyaçlarınıza özel
                    çözümler üretiyoruz.
                  </p>
                </div>
              </div>
            ...
            <div className="grid md:grid-cols-2 gap-16">
              <div>
                ...
                <div className="space-y-4">
                  {references
                    .slice(0, showAllReferences ? references.length : 3)
                    .map((ref, index) => (
                      <div
                        key={index}
                ...
                <div className="bg-blue-800 rounded-2xl border border-blue-700 p-6 shadow-lg space-y-6">
                  ...
                  <div className="bg-blue-900/60 rounded-xl p-4 border border-blue-600 flex items-start gap-3">
                    ...
                    <div className="text-xs">
                      ...
                      <p className="text-blue-100 mb-1">
                        Gerçek kullanıcı yorumları ve projelere dair
                        geri bildirimler.
                      </p>
        ...
        <div className="mx-auto max-w-6xl px-6 grid md:grid-cols-4 gap-8 mb-8">
          <div className="col-span-2">
            ...
            <p className="text-xs leading-relaxed text-slate-400 max-w-xs">
              Güvenli, konforlu ve verimli dikey ulaşım çözümleri için
              mühendislik odaklı yaklaşım. Yük asansörleri, yük platformları,
              villa asansörleri ve yatay asansörler için Türkiye’nin her
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm p-4">
          <div className="w-full max-w-md rounded-xl bg-white p-6 shadow-2xl max-h-[90vh] overflow-y-auto animate-in fade-in zoom-in duration-200">
            ...
            <p className="mb-5 text-xs text-slate-500">
              Bilgileri doldurun, WhatsApp üzerinden uzmanlarımız size
              ulaşsın.
            </p>
            <form
          ...
          <div className="w-full max-w-lg rounded-xl bg-white p-6 shadow-2xl max-h-[80vh] overflow-y-auto animate-in fade-in zoom-in duration-200">
            ...
            <div className="space-y-3">
              {Object.keys(tempValue).map((key) => {
                // 'id' gibi sistem alanlarını gizle
                if (key === "id" || key === "title") return null;

                // GALERİYE ÖZEL: TYPE SEÇİMİ
                if (editModal.type === "gallery" && key === "type") {
                  return (
                    <div key={key}>
                ...
                // GALERİYE ÖZEL: URL ALANI
                if (editModal.type === "gallery" && key === "url") {
                  return (
                    <div key={key}>
                      <label className="mb-1 block text-[10px] font-bold text-slate-500 uppercase">
                        Bağlantı (resim, video, Instagram / Facebook URL)
                      </label>
                      <input
                        type="text"
                        value={tempValue[key]}
