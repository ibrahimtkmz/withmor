        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-4">
          ...
          <div className="hidden md:flex items-center gap-4">
             ...
             >
                ...
                <option value="premium">Premium Tema</option>
                <option value="hightech">High-Tech Tema</option>
             </select>
        ...
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          ...
          <div className="hidden md:flex items-center gap-6">
             <select 
               value={props.currentTheme} 
               onChange={(e) => setCurrentTheme(e.target.value)}
               className="bg-slate-50 border border-slate-200 text-xs text-slate-600 rounded px-2 py-1 outline-none focus:border-blue-500"
             >
                <option value="dark">Koyu Tema</option>
                <option value="corporate">Kurumsal Tema</option>
                <option value="premium">Premium Tema</option>
         ...
         <div className="max-w-7xl mx-auto px-6 py-5 flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center gap-8 font-sans text-xs font-bold tracking-widest uppercase">
               <select 
                  value={props.currentTheme} 
                  onChange={(e) => setCurrentTheme(e.target.value)}
                  className="bg-transparent border-b border-stone-300 text-xs text-stone-600 pb-1 outline-none"
               >
               ...
               <a href="#services" className="hover:text-orange-700">Koleksiyon</a>
         ...
         <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <div className="hidden md:flex items-center gap-6 text-xs">
               <select 
                  value={props.currentTheme} 
                  onChange={(e) => setCurrentTheme(e.target.value)}
                  className="bg-black border border-cyan-900 text-cyan-500 px-2 py-1 outline-none focus:border-cyan-400"
               >
                  <option value="dark">Koyu</option>
                  <option value="corporate">Kurumsal</option>
                  <option value="premium">Premium</option>
