...
// LOGO YOLU (kendi projenin path’ine göre güncelleyebilirsin)
const LOGO_SRC = "/images/withmor-logo.png";
          ...
          <div className="flex justify-start items-center gap-6 w-full">
            ...
            <div className="relative h-96 w-40 shrink-0 overflow-hidden rounded-md border-2 border-slate-300 bg-slate-100 shadow-inner">
              ...
              >
                ...
                {/* LOGO – WL yazısının yerine */}
                <div className="relative flex items-center justify-center w-14 h-10">
                  <img
                    src={LOGO_SRC}
                    alt="Withmor Logo"
                    className="max-w-full max-h-full object-contain drop-shadow-[0_0_6px_rgba(15,23,42,0.6)]"
                  />
                </div>
              </div>
            ...
            <div className="flex flex-col justify-between h-[18rem] py-2 w-full">
              {elevatorModels.slice().reverse().map((item) => (
                ...
                >
                  <div className="indicator-circle w-10 h-10 shrink-0 rounded-full border-2 border-slate-300 flex items-center justify-center text-[10px] font-bold text-slate-400 transition-all duration-300 text-center px-1 overflow-hidden bg-white">
                    {/* Küçük daire içi logo */}
                    <img
                      src={LOGO_SRC}
                      alt="Withmor Logo"
...
export default function App() {
  ...
  // REFERANSLAR...
  // (DEVAM EDEN TÜM KODUNU **AYNEN** BIRAKIYORUM, SADECE LOGO ALANLARINI AŞAĞIDA GÜNCELLİYORUM)
  ...
  // ... (buradan itibaren tüm handler ve state'ler aynı, değişiklik yok)
      ...
      <header className="sticky top-0 z-30 border-b border-slate-200 bg-white/95 backdrop-blur-md">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4">
          <div className="flex items-center gap-3">
            {/* LOGO KUTUSU - WL yerine görsel */}
            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-white border border-blue-900 shadow-md overflow-hidden">
              <img
                src={LOGO_SRC}
                alt="Withmor Logo"
